	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">	
			<div class="col-sm-12 text-center">
				<h3 class="card-title fs-20 mb-0 super-strong"><i class="fa-solid fa-brain-circuit mr-2 text-primary"></i>{{ __('AI Vision') }}</h3>
								...
								<div id="chat-container">
									...
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											...
											<input type="file" class="main-image-input" name="main_image" id="main_image">
