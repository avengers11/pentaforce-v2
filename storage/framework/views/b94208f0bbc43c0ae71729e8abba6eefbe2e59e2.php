...
unset($__errorArgs, $__bag); ?>	
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><?php echo e(__('SEO Keywords')); ?> <span class="text-muted">(<?php echo e(__('Optional, Comma Separated')); ?>)</span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Blog Status')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
			  						<select id="smtp-encryption" name="status" class="form-select" data-placeholder="<?php echo e(__('Blog Status')); ?>:">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel\codecanyon_EuK0LLc4_openai_davinci_ai_writing_assistant_and_content\openaidavinci-3.5\resources\views/admin/frontend/blog/create.blade.php ENDPATH**/ ?>